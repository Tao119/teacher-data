...
async def _stats(db: AsyncSession, project_id: str) -> ProjectStats:
    ...
    return ProjectStats(total_records=total or 0, train_count=train or 0, review_count=review or 0, avg_similarity=round(avg_sim, 3), total_audio_files=total_af or 0)
